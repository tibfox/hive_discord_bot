...
import (
	...
	"github.com/disgoorg/bot-template/era2bot/commands"
	"github.com/disgoorg/bot-template/era2bot/components"
	"github.com/disgoorg/bot-template/era2bot/handlers"
...
func main() {
	...
	cfg, err := era2bot.LoadConfig(*path)
	if err != nil {
	...
	mySqlTools.InitDB("user:pass@tcp(localhost:3306)/dbname")
	defer mySqlTools.DB.Close()
	...
	b := era2bot.New(*cfg, Version, Commit)
...
func setupLogger(cfg era2bot.LogConfig) {
